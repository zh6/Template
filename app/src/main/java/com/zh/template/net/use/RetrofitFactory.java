...
import com.zh.template.net.interceptor.HeaderInterceptor;
import com.zh.template.net.interceptor.LogInterceptor;
...
public class RetrofitFactory {
    ...
    private RetrofitFactory() {
        ...
        build = retrofit.baseUrl(SPUtil.SYSTEM.getString("ip", "")).build();
    }
