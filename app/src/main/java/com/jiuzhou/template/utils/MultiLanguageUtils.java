...
public class MultiLanguageUtils {
    ...
    public static void changeLanguage(Context context, String language, String area) {
        if (TextUtils.isEmpty(language) && TextUtils.isEmpty(area)) {
            //如果语言和地区都是空，那么跟随系统
            SpUtils.SYSTEM.putString(Constants.SP_LANGUAGE, "").putString(Constants.SP_LANGUAGE, "");
        } else {
    ...
    public static Context attachBaseContext(Context context) {
        String spLanguage = SpUtils.SYSTEM.getString(Constants.SP_LANGUAGE);
        String spCountry = SpUtils.SYSTEM.getString(Constants.SP_COUNTRY);
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = SpUtils.SYSTEM.getString(Constants.SP_LANGUAGE);
        String sp_country = SpUtils.SYSTEM.getString(Constants.SP_COUNTRY);
    ...
    public static void saveLanguageSetting(Context context, Locale locale) {
        SpUtils.SYSTEM.putString(Constants.SP_LANGUAGE, locale.getLanguage()).putString(Constants.SP_COUNTRY, locale.getCountry());
    }
    ...
    public static Application.ActivityLifecycleCallbacks callbacks = new Application.ActivityLifecycleCallbacks() {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            String language = SpUtils.SYSTEM.getString(Constants.SP_LANGUAGE);
            String country = SpUtils.SYSTEM.getString(Constants.SP_COUNTRY);
