...
public class GlideUtils {
    /*** 占位图 */
    public static int placeholderImage = R.drawable.placeholder_image;
    /*** 错误图 */
    public static int errorImage = R.drawable.error_image;
    ...
    public static void loadImage(Context context, String url, ImageView imageView) {
        ...
        Glide.with(context).load(TextUtils.isEmpty(url)?placeholderImage:(url.startsWith("http")?url: SpUtils.SYSTEM.getStringDef(Constants.IP, Constants.API_URL)+url)).apply(options).into(imageView);
     ...
     * @param imageView ImageView
     */
    public static void loadCircleImage(Context context, String url, ImageView imageView,int width, int height) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .override(width, height)
