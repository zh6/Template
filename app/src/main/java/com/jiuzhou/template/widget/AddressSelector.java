...
import com.jiuzhou.template.module.main.entity.AddressEntity;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    ...
    private void init(Context context){
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.gray));
        addView(grayLine);
    ...
    public void setCities(List<AddressEntity> cities) {
        if(cities == null||cities.size() <= 0)
            return;
        if(cities.get(0) instanceof AddressEntity){
            this.cities = cities;
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder>{
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            if(TextUtils.equals(tabs.get(tabIndex).getText(),cities.get(position).areaName)){
            ...
            holder.tv.setText(cities.get(position).areaName);
            holder.itemView.setTag(cities.get(position));
            holder.itemView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(onItemClickListener != null){
                        onItemClickListener.itemClick(AddressSelector.this,(AddressEntity) v.getTag(),tabIndex,position);
                        tabs.get(tabIndex).setText(((AddressEntity) v.getTag()).areaName);
    ...
    public interface OnItemClickListener {
        void itemClick(AddressSelector addressSelector, AddressEntity addressEntity, int tabPosition, int selectPostion);
    }
}
